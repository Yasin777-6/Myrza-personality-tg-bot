...
BASE_MEMORIES = [
    "Мансур назвал учительницу Марину Чупахиной, после чего Ясину поставили тройку по диктанту.",
    "Актан рассказал, что птица насрала ему на голову, когда он шел за хлебом.",
    "Ясин вспомнил, как они с Актаном в 7 утра ждали Артура, пока тот завтракал бутербродом.",
    "Мансур вспомнил, как их толпой гопнули в Токтогуле, а на следующий день почти все парни пришли.",
    "Ясин вспомнил, как по 10 яиц хавал, после чего неделю болел живот.",
    "Мансур рассказал, как нес хуйню индусам на русском, думая, что они не понимают.",
    "Актан вспомнил, как ему и другим надавали, и неделю была шишка.",
    "Ясин вспомнил, как на физике его голова застряла в стульчике, и учитель вытаскивал его.",
    "Мансур вспомнил, как Мырза на физре начал орать маты и убегал, думая, что его не поймают.",
    "Актан вспомнил, как Амантура брали на руки и пытались пробить очко.",
    "Ясин вспомнил, как они с Исламом подрались, и Мансур контрил Ислама.",
    "Мансур вспомнил, как в ресторане было некруто, и Актан сказал, что ему не нужен выпускной.",
    "Ясин вспомнил, как задал вопрос про Путина, и Полина заплакала.",
    "Актан вспомнил, как на камеру попали, и было видно, как он кого-то чпокал.",
    "Ясин вспомнил, как Мырза не получил свои 100 щелбанов.",
    "Мансур вспомнил, как про Айпери говорил.",
    "Ясин вспомнил, как они с Актаном оставались после уроков, и учительница по алгебре не выходила из кабинета.",
    "Актан вспомнил, как на проекте делал лого и не выдал его даже спустя день.",
    "Ясин вспомнил, как на хакатоне в Codify выиграл стартап с оценкой 2 млн долларов.",
    "Мансур вспомнил, как в пк клубе к ним докопались парни, и они вышли на улицу.",
    "Ясин вспомнил, как на TIFE выиграли карточки для туристов.",
    "Актан вспомнил, как на спикинге разговаривали, и Артура называли Чоджи.",
    "Ясин вспомнил, как Бека был отличником, и Актан пнул кого-то по жопе в коридоре.",
    "Мансур вспомнил, как они снимали что-то, и после этого пошли играть в стендофф в столовую.",
    "Ясин вспомнил, как на словах был Лев Толстой, а на деле Хабиб Нурмагомедов."
]
